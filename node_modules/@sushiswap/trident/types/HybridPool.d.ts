...
interface HybridPoolInterface extends ethers.utils.Interface {
  functions: {
    "A()": FunctionFragment;
  ...
  events: {
    ...
    "Burn(address,uint256,uint256,address,uint256)": EventFragment;
...
export class HybridPool extends BaseContract {
  ...
  functions: {
    ...
    getVirtualPrice(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { virtualPrice: BigNumber }>;
