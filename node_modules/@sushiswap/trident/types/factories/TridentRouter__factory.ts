...
import type { TridentRouter, TridentRouterInterface } from "../TridentRouter";
...
export class TridentRouter__factory extends ContractFactory {
  ...
  ): Promise<TridentRouter> {
    return super.deploy(
      bento,
      masterDeployer,
      wETH,
      overrides || {}
    ) as Promise<TridentRouter>;
  }
  ...
  attach(address: string): TridentRouter {
    return super.attach(address) as TridentRouter;
  }
  connect(signer: Signer): TridentRouter__factory {
    return super.connect(signer) as TridentRouter__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TridentRouterInterface {
    return new utils.Interface(_abi) as TridentRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TridentRouter {
    return new Contract(address, _abi, signerOrProvider) as TridentRouter;
  }
}
