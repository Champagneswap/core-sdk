...
import type {
  ...
  ConstantProductPoolFactoryInterface,
} from "../ConstantProductPoolFactory";
...
export class ConstantProductPoolFactory__factory extends ContractFactory {
  ...
  ): Promise<ConstantProductPoolFactory> {
    return super.deploy(
      _masterDeployer,
      overrides || {}
    ) as Promise<ConstantProductPoolFactory>;
  }
  ...
  attach(address: string): ConstantProductPoolFactory {
    return super.attach(address) as ConstantProductPoolFactory;
  }
  connect(signer: Signer): ConstantProductPoolFactory__factory {
    return super.connect(signer) as ConstantProductPoolFactory__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ConstantProductPoolFactoryInterface {
    return new utils.Interface(_abi) as ConstantProductPoolFactoryInterface;
  }
  static connect(
    address: string,
