...
interface ITridentRouterMinimalInterface extends ethers.utils.Interface {
  functions: {
...
export class ITridentRouterMinimal extends BaseContract {
  ...
  interface: ITridentRouterMinimalInterface;
