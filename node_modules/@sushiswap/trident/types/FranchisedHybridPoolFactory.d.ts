...
interface FranchisedHybridPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class FranchisedHybridPoolFactory extends BaseContract {
  ...
  interface: FranchisedHybridPoolFactoryInterface;
