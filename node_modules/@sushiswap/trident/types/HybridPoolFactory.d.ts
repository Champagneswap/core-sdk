...
interface HybridPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class HybridPoolFactory extends BaseContract {
  ...
  interface: HybridPoolFactoryInterface;
