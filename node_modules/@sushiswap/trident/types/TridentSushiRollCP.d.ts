...
interface TridentSushiRollCPInterface extends ethers.utils.Interface {
  functions: {
    "batch(bytes[])": FunctionFragment;
    "migrate(address,uint256,uint256,bool,uint256)": FunctionFragment;
...
export class TridentSushiRollCP extends BaseContract {
