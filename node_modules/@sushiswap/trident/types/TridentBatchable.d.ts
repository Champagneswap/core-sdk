...
interface TridentBatchableInterface extends ethers.utils.Interface {
  functions: {
...
export class TridentBatchable extends BaseContract {
  ...
  interface: TridentBatchableInterface;
