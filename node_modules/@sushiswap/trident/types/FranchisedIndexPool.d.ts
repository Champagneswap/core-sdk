...
interface FranchisedIndexPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class FranchisedIndexPool extends BaseContract {
  ...
  interface: FranchisedIndexPoolInterface;
