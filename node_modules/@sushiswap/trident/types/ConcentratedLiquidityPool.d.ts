...
interface ConcentratedLiquidityPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "decreaseLiquidity(int24,int24,uint128,address,bool)": FunctionFragment;
...
export class ConcentratedLiquidityPool extends BaseContract {
  ...
  getAmountIn(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    decreaseLiquidity(
      ...
      [
        ...
        withdrawnAmounts: ([string, BigNumber] & {
          token: string;
          amount: BigNumber;
        })[];
        feesWithdrawn: ([string, BigNumber] & {
          token: string;
          amount: BigNumber;
        })[];
        oldLiquidity: BigNumber;
      }
    >;
  ...
  estimateGas: {
    ...
    burn(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
