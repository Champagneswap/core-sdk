...
interface ConcentratedLiquidityPoolManagerInterface
  ...
  functions: {
    ...
    "decreaseLiquidity(uint256,uint128,address,bool)": FunctionFragment;
    ...
    "positionMintCallback(address,int24,int24,uint128,uint256,uint256,uint256)": FunctionFragment;
  ...
  events: {
    ...
    "DecreaseLiquidity(address,address,uint256,uint128)": EventFragment;
    "IncreaseLiquidity(address,address,uint256,uint128)": EventFragment;
