...
interface IndexPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IndexPoolFactory extends BaseContract {
  ...
  interface: IndexPoolFactoryInterface;
