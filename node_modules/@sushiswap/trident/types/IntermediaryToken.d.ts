...
interface IntermediaryTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IntermediaryToken extends BaseContract {
  ...
  interface: IntermediaryTokenInterface;
