...
export declare class ConstantProductPool implements Pool {
    ...
    getMintFee(reserve0: JSBI, reserve1: JSBI, totalSupply: JSBI): JSBI;
    ...
    getAmountOut(amountIn: JSBI, reserveAmountIn: JSBI, reserveAmountOut: JSBI): JSBI;
    getLiquidityValueSingleToken(token: Token, totalSupply: CurrencyAmount<Token>, liquidity: CurrencyAmount<Token>): CurrencyAmount<Token>;
}
